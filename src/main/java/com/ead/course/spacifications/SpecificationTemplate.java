package com.ead.course.spacifications;
    ...
    public static Specification<ModuleModel> moduleCourseId(final UUID courseId) {
        return (root, query, cb) -> {
          query.distinct(true);
            ...
            Expression<Collection<ModuleModel>> courseModules = course.get("modules"); //Coleção da Entidade A na Entidade B
            //construção CriteriaBuilder utilizando AND
